							...
							<div class="login-form form-item form-stl">
								...
								<form name="frm-login" action="{{route('login')}}" method="POST">
									...
									<fieldset class="wrap-input">
										...
										<input type="email" id="frm-login-uname" name="email" placeholder="Tapez votre address email" :value="old('email')" required autofocus>
									</fieldset>
									<fieldset class="wrap-input">
									...
									<fieldset class="wrap-input">
										<label class="remember-field">
											<input class="frm-input " name="remember" id="rememberme" value="forever" type="checkbox"><span>Souviens-toi de moi</span>
										</label>
