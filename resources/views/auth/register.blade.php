							...
							<div class="register-form form-item ">
								...
								<form class="form-stl" action="{{route('register')}}" name="frm-login" method="POST" >
                                    ...
                                    <fieldset class="wrap-title">
										<h3 class="form-title">Crèer un compte</h3>
										<h4 class="form-subtitle">Infomations personnelles</h4>
									</fieldset>									
									<fieldset class="wrap-input">
										<label for="frm-reg-lname">Nom complet*</label>
										<input type="text" id="frm-reg-lname" name="name" placeholder="Votre nom complet*" :value="old('name')" required autofocus autocomplete="name" >
									</fieldset>
									<fieldset class="wrap-input">
									...
									<fieldset class="wrap-input item-width-in-half left-item ">
										...
										<input type="password" id="frm-reg-pass" name="password" placeholder="Password" autocomplete="new-password" required>
									</fieldset>
									<fieldset class="wrap-input item-width-in-half ">
										<label for="frm-reg-cfpass">Confirmer le mot de passe *</label>
										<input type="password" id="frm-reg-cfpass" name="password_confirmation" placeholder="Confirmer votre mot de passe" required autocomplete="new-password">
									</fieldset>
